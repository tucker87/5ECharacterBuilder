...
namespace _5ECharacterBuilder
{
    class CharacterData
    {
        ...
        public static Dictionary<string, string> GeneralClassFeatures => 
        ...
        public static Dictionary<string, string> RaceFeatures =>
            new Dictionary<string, string>(DwarvenFeatures)
            {
        ...
        public static Dictionary<string, string> ClassFeatures =>
            new Dictionary<string, string>(MonkFeatures)
                .Union(RogueFeatures)
                .Union(BarbarianFeatures)
                .Union(GeneralClassFeatures)
        ...
        public static Dictionary<AvailableSkill, AvailableAbility> SkillMods =>
            new Dictionary<AvailableSkill, AvailableAbility>
            {
