...
namespace _5ECharacterBuilder.CharacterBackgrounds
{
    class CharacterBackground : ICharacter
    {
        ...
        public virtual int BackgroundLanguageCount { get { return _character.BackgroundLanguageCount; } }
        ...
        public List<string> RuleIssues
        {
            get
            {
                ...
                if (BackgroundLanguages.Count > BackgroundLanguageCount)
                    currentIssues.Add(string.Format("{0}s can only choose {1} Language", Background, BackgroundLanguageCount));
