namespace _5ECharacterBuilder
{
    ...
    public enum AvailableSkill { Acrobat, Arcana, Athletics, AnimalHandling, Deception, History, Insight, Medicine, Perception, Religion, Stealth,
        Intimidation,
        Survival
    }
    public enum AvailableTool { AlchemistsSupplies }
